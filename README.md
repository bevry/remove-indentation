...
``` typescript
import pkg from 'https://unpkg.com/remove-indentation@^5.4.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/remove-indentation@^5.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/remove-indentation@^5.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/remove-indentation@5.4.0'
</script>
```
